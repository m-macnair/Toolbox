...
apt-get install --assume-yes screen build-essential iptables git net-tools screen sudo  htop rsync perl ntpdate gparted mtools pass sqlite3 cron >> ~/apt_install.log
